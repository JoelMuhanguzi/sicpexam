...
; fiction story book
(define moby (string->url "https://github.com/JoelMuhanguzi/sicpexam/blob/main/Uganda_sampletweets.txt"))

;(define moby (string->url "http://textfiles.com/stories/reality.txt"))
...
;;; We can take a sneak peak at the data structure...
(take sentiment 5)
